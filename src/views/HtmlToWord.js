...
export var initEditContent = `
<table cellspacing="0" cellpadding="0" align="center" width="979">
    <tbody>
        ...
        <tr style="height:1px;" class="firstRow">
            ...
            <td style="border-top: 1px solid black; border-right: 1px solid black; border-bottom: 1px solid black; border-left: none black; background: rgb(68, 114, 196); padding: 5px 10px; border-image: initial;" height="1" width="245">
                <p style="text-align:center"><strong><span style="font-size:   19px;font-family:宋体;color:white">活动</span></strong></p>
            </td>
            <td style="border-top: 1px solid black; border-right: 1px solid black; border-bottom: 1px solid black; border-left: none black; background: rgb(68, 114, 196); padding: 5px 10px; border-image: initial;" height="1" width="244">
        ...
        <tr style="height:1px;">
            ...
            <td valign="top" style="border-top: none black; border-left: none black; border-bottom: 1px solid black; border-right: 1px solid black; background: rgb(207, 213, 234); padding: 5px 10px;" height="1" width="245"></td>
            <td style="border-top: none black; border-left: none black; border-bottom: 1px solid black; border-right: 1px solid black; background: rgb(207, 213, 234); padding: 5px 10px;" height="1" width="undefined"></td>
        </tr>
    </tbody>
</table>
`
...
export const set_localStorage_editContent = (item, value) => {
  let key = 'edit_content'
  let content = localStorage.getItem(key)
  let preJson = content ? JSON.parse(content) : {}
  preJson[item] = value
  localStorage.setItem(key, JSON.stringify(preJson))
}
export const get_localStorage_editContent = (item) => {
  let key = 'edit_content'
  let content = localStorage.getItem(key)
  let preJson = content ? JSON.parse(content) : {}
  return preJson[item] || ''
